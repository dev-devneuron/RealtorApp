            ...
            >
              <TabsList className="bg-gradient-to-br from-amber-50/90 via-white to-amber-50/70 border-2 border-amber-200/90 rounded-2xl shadow-xl backdrop-blur-sm w-full p-0 overflow-hidden relative">
                ...
                <div className="relative w-full overflow-x-auto overflow-y-hidden scroll-smooth
                  ...
                  <div className="flex gap-1.5 sm:gap-2 md:gap-2.5 lg:gap-3 xl:gap-2.5 items-center 
                    min-h-[52px] sm:min-h-[56px] md:min-h-[60px] lg:min-h-[56px] xl:min-h-[54px] 
                    px-2 sm:px-3 md:px-4 lg:px-6 xl:px-6 2xl:px-8 
                    py-2 sm:py-2.5 md:py-3 lg:py-3 xl:py-2.5">
                {userType === "property_manager" && (
                  <>
                    <TabsTrigger 
                      value="realtors" 
                      className="data-[state=active]:bg-gradient-to-br data-[state=active]:from-amber-500 data-[state=active]:to-amber-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/30 data-[state=active]:scale-[1.02] rounded-xl px-2.5 sm:px-3 md:px-4 lg:px-4 xl:px-5 py-2 sm:py-2.5 md:py-2.5 lg:py-2.5 xl:py-2.5 font-semibold transition-all duration-300 ease-out text-[11px] sm:text-xs md:text-sm lg:text-sm xl:text-[12px] whitespace-nowrap flex-shrink-0 min-h-[44px] sm:min-h-[48px] md:min-h-[52px] lg:min-h-[52px] xl:min-h-[50px] data-[state=inactive]:text-gray-700 data-[state=inactive]:hover:text-amber-700 data-[state=inactive]:hover:bg-amber-50/90 data-[state=inactive]:hover:scale-[1.01] border-2 border-transparent data-[state=active]:border-amber-400/40 data-[state=active]:ring-2 data-[state=active]:ring-amber-300/30 relative group items-center justify-center"
                    >
                      <Users className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-4 md:w-4 lg:h-4 lg:w-4 xl:h-4 xl:w-4 mr-1 sm:mr-1.5 md:mr-1.5 lg:mr-1.5 xl:mr-2 flex-shrink-0" />
                    ...
                    <TabsTrigger 
                      ...
                      className="data-[state=active]:bg-gradient-to-br data-[state=active]:from-amber-500 data-[state=active]:to-amber-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/30 data-[state=active]:scale-[1.02] rounded-xl px-2.5 sm:px-3 md:px-4 lg:px-4 xl:px-5 py-2 sm:py-2.5 md:py-2.5 lg:py-2.5 xl:py-2.5 font-semibold transition-all duration-300 ease-out text-[11px] sm:text-xs md:text-sm lg:text-sm xl:text-[12px] whitespace-nowrap flex-shrink-0 min-h-[44px] sm:min-h-[48px] md:min-h-[52px] lg:min-h-[52px] xl:min-h-[50px] data-[state=inactive]:text-gray-700 data-[state=inactive]:hover:text-amber-700 data-[state=inactive]:hover:bg-amber-50/90 data-[state=inactive]:hover:scale-[1.01] border-2 border-transparent data-[state=active]:border-amber-400/40 data-[state=active]:ring-2 data-[state=active]:ring-amber-300/30 relative group items-center justify-center"
                    >
                      <CheckSquare className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-4 md:w-4 lg:h-4 lg:w-4 xl:h-4 xl:w-4 mr-1 sm:mr-1.5 md:mr-1.5 lg:mr-1.5 xl:mr-2 flex-shrink-0" />
                    ...
                    <TabsTrigger 
                      ...
                      className="data-[state=active]:bg-gradient-to-br data-[state=active]:from-amber-500 data-[state=active]:to-amber-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/30 data-[state=active]:scale-[1.02] rounded-xl px-2.5 sm:px-3 md:px-4 lg:px-4 xl:px-5 py-2 sm:py-2.5 md:py-2.5 lg:py-2.5 xl:py-2.5 font-semibold transition-all duration-300 ease-out text-[11px] sm:text-xs md:text-sm lg:text-sm xl:text-[12px] whitespace-nowrap flex-shrink-0 min-h-[44px] sm:min-h-[48px] md:min-h-[52px] lg:min-h-[52px] xl:min-h-[50px] data-[state=inactive]:text-gray-700 data-[state=inactive]:hover:text-amber-700 data-[state=inactive]:hover:bg-amber-50/90 data-[state=inactive]:hover:scale-[1.01] border-2 border-transparent data-[state=active]:border-amber-400/40 data-[state=active]:ring-2 data-[state=active]:ring-amber-300/30 relative group items-center justify-center"
                    >
                      <ListChecks className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-4 md:w-4 lg:h-4 lg:w-4 xl:h-4 xl:w-4 mr-1 sm:mr-1.5 md:mr-1.5 lg:mr-1.5 xl:mr-2 flex-shrink-0" />
                    ...
                    <TabsTrigger 
                      ...
                      className="data-[state=active]:bg-gradient-to-br data-[state=active]:from-amber-500 data-[state=active]:to-amber-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/30 data-[state=active]:scale-[1.02] rounded-xl px-2.5 sm:px-3 md:px-4 lg:px-4 xl:px-5 py-2 sm:py-2.5 md:py-2.5 lg:py-2.5 xl:py-2.5 font-semibold transition-all duration-300 ease-out text-[11px] sm:text-xs md:text-sm lg:text-sm xl:text-[12px] whitespace-nowrap flex-shrink-0 min-h-[44px] sm:min-h-[48px] md:min-h-[52px] lg:min-h-[52px] xl:min-h-[50px] data-[state=inactive]:text-gray-700 data-[state=inactive]:hover:text-amber-700 data-[state=inactive]:hover:bg-amber-50/90 data-[state=inactive]:hover:scale-[1.01] border-2 border-transparent data-[state=active]:border-amber-400/40 data-[state=active]:ring-2 data-[state=active]:ring-amber-300/30 relative group items-center justify-center"
                    >
                      <Building2 className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-4 md:w-4 lg:h-4 lg:w-4 xl:h-4 xl:w-4 mr-1 sm:mr-1.5 md:mr-1.5 lg:mr-1.5 xl:mr-2 flex-shrink-0" />
                    ...
                    <TabsTrigger 
                      ...
                      className="data-[state=active]:bg-gradient-to-br data-[state=active]:from-amber-500 data-[state=active]:to-amber-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/30 data-[state=active]:scale-[1.02] rounded-xl px-2.5 sm:px-3 md:px-4 lg:px-4 xl:px-5 py-2 sm:py-2.5 md:py-2.5 lg:py-2.5 xl:py-2.5 font-semibold transition-all duration-300 ease-out text-[11px] sm:text-xs md:text-sm lg:text-sm xl:text-[12px] whitespace-nowrap flex-shrink-0 min-h-[44px] sm:min-h-[48px] md:min-h-[52px] lg:min-h-[52px] xl:min-h-[50px] data-[state=inactive]:text-gray-700 data-[state=inactive]:hover:text-amber-700 data-[state=inactive]:hover:bg-amber-50/90 data-[state=inactive]:hover:scale-[1.01] border-2 border-transparent data-[state=active]:border-amber-400/40 data-[state=active]:ring-2 data-[state=active]:ring-amber-300/30 relative group items-center justify-center"
                    >
                      <Phone className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-4 md:w-4 lg:h-4 lg:w-4 xl:h-4 xl:w-4 mr-1 sm:mr-1.5 md:mr-1.5 lg:mr-1.5 xl:mr-2 flex-shrink-0" />
              ...
              <TabsTrigger 
                value="call-forwarding" 
                    className="data-[state=active]:bg-gradient-to-br data-[state=active]:from-amber-500 data-[state=active]:to-amber-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/30 data-[state=active]:scale-[1.02] rounded-xl px-2.5 sm:px-3 md:px-4 lg:px-4 xl:px-5 py-2 sm:py-2.5 md:py-2.5 lg:py-2.5 xl:py-2.5 font-semibold transition-all duration-300 ease-out text-[11px] sm:text-xs md:text-sm lg:text-sm xl:text-[12px] whitespace-nowrap flex-shrink-0 min-h-[44px] sm:min-h-[48px] md:min-h-[52px] lg:min-h-[52px] xl:min-h-[50px] data-[state=inactive]:text-gray-700 data-[state=inactive]:hover:text-amber-700 data-[state=inactive]:hover:bg-amber-50/90 data-[state=inactive]:hover:scale-[1.01] border-2 border-transparent data-[state=active]:border-amber-400/40 data-[state=active]:ring-2 data-[state=active]:ring-amber-300/30 relative group items-center justify-center"
              >
                <PhoneForwarded className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-4 md:w-4 lg:h-4 lg:w-4 xl:h-4 xl:w-4 mr-1 sm:mr-1.5 md:mr-1.5 lg:mr-1.5 xl:mr-2 flex-shrink-0" />
                ...
                <TabsTrigger 
                  value="maintenance-requests" 
                    className="data-[state=active]:bg-gradient-to-br data-[state=active]:from-amber-500 data-[state=active]:to-amber-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/30 data-[state=active]:scale-[1.02] rounded-xl px-2.5 sm:px-3 md:px-4 lg:px-4 xl:px-5 py-2 sm:py-2.5 md:py-2.5 lg:py-2.5 xl:py-2.5 font-semibold transition-all duration-300 ease-out text-[11px] sm:text-xs md:text-sm lg:text-sm xl:text-[12px] whitespace-nowrap flex-shrink-0 min-h-[44px] sm:min-h-[48px] md:min-h-[52px] lg:min-h-[52px] xl:min-h-[50px] data-[state=inactive]:text-gray-700 data-[state=inactive]:hover:text-amber-700 data-[state=inactive]:hover:bg-amber-50/90 data-[state=inactive]:hover:scale-[1.01] border-2 border-transparent data-[state=active]:border-amber-400/40 data-[state=active]:ring-2 data-[state=active]:ring-amber-300/30 relative group items-center justify-center"
                >
                  <AlertTriangle className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-4 md:w-4 lg:h-4 lg:w-4 xl:h-4 xl:w-4 mr-1 sm:mr-1.5 md:mr-1.5 lg:mr-1.5 xl:mr-2 flex-shrink-0" />
                ...
                <TabsTrigger 
                  value="bookings" 
                    className="data-[state=active]:bg-gradient-to-br data-[state=active]:from-amber-500 data-[state=active]:to-amber-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-amber-500/30 data-[state=active]:scale-[1.02] rounded-xl px-2.5 sm:px-3 md:px-4 lg:px-4 xl:px-5 py-2 sm:py-2.5 md:py-2.5 lg:py-2.5 xl:py-2.5 font-semibold transition-all duration-300 ease-out text-[11px] sm:text-xs md:text-sm lg:text-sm xl:text-[12px] whitespace-nowrap flex-shrink-0 min-h-[44px] sm:min-h-[48px] md:min-h-[52px] lg:min-h-[52px] xl:min-h-[50px] data-[state=inactive]:text-gray-700 data-[state=inactive]:hover:text-amber-700 data-[state=inactive]:hover:bg-amber-50/90 data-[state=inactive]:hover:scale-[1.01] border-2 border-transparent data-[state=active]:border-amber-400/40 data-[state=active]:ring-2 data-[state=active]:ring-amber-300/30 relative group items-center justify-center"
                >
                  <Calendar className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-4 md:w-4 lg:h-4 lg:w-4 xl:h-4 xl:w-4 mr-1 sm:mr-1.5 md:mr-1.5 lg:mr-1.5 xl:mr-2 flex-shrink-0" />
                  <span>Bookings</span>
                </TabsTrigger>
                  </div>
                </div>
